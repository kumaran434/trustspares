...
const SellerOnboarding: React.FC = () => {
  ...
  // --- 2. PENDING STATUS ---
  if (currentUser.kycStatus === 'PENDING' && !isSuccess) {
       return (
           <div className="pb-24 bg-gray-50 min-h-screen flex flex-col items-center justify-center p-6 text-center animate-in zoom-in duration-300">
  ...
  // --- 3. REJECTED STATUS ---
  if (currentUser.kycStatus === 'REJECTED' && !isSuccess) {
      return (
          <div className="pb-24 bg-gray-50 min-h-screen flex flex-col items-center justify-center p-6 text-center animate-in zoom-in duration-300">
               ...
               <button onClick={() => window.location.reload()} className="w-full max-w-sm bg-slate-900 text-white font-bold py-4 rounded-2xl shadow-lg hover:bg-slate-800 transition-all active:scale-95 flex items-center justify-center gap-2">
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-20">
       ...
       <div className="p-6 max-w-md mx-auto animate-in fade-in slide-in-from-bottom duration-500">
            ...
            <div className="mb-8">
                <h1 className="text-2xl font-extrabold text-slate-900 mb-2">Technician Access</h1>
